...
int PlotPrep(struct global_type *pGlobals, struct flag_type *pFlags);
...
/*************************************/
void startPC(struct global_type *pGlobals, struct flag_type *pFlags) {
/*************************************/
...
/**********************************************************/
	...
	if (err == 0)err = loadMaterials(pGlobals->pMtrl_data);  // Load materials file
    return err;
}
