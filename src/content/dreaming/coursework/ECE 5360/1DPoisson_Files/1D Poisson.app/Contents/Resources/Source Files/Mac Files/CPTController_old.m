...
- (void)windowDidLoad
{
    ...
    [controller initWithWindowNibName:@"CPTPlotDocument"];
    [super windowControllerDidLoadNib:controller];
    [controller showWindow:nil];
    [controller init];
    NSString *string = [controller windowNibName];
    NSLog(string);*/
    ...
    minimumValueForXAxis = 1.0;
    maximumValueForXAxis = 2.0;
    minimumValueForYAxis = 1.0;
    maximumValueForYAxis = 2.0;
    ...
    [dataPoints addObject:[NSMutableDictionary dictionaryWithObjectsAndKeys:[NSNumber numberWithDouble:1.0], @"x", [NSNumber numberWithDouble:1.0], @"y", nil]];
    [dataPoints addObject:[NSMutableDictionary dictionaryWithObjectsAndKeys:[NSNumber numberWithDouble:1.5], @"x", [NSNumber numberWithDouble:1.25], @"y", nil]];
    [dataPoints addObject:[NSMutableDictionary dictionaryWithObjectsAndKeys:[NSNumber numberWithDouble:2.0], @"x", [NSNumber numberWithDouble:2.0], @"y", nil]];
